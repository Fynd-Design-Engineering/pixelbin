        ...
        const prompts = {
            'Video Generator': 'Create a cinematic sci-fi cityscape from a low, upward angle, with subtle motion and dynamic energy. A lone man in a dark jacket stands in the foreground, back to camera, gazing upward as mist drifts and light particles float through the air. Towering futuristic skyscrapers loom on both sides while a colossal circular megastructure rotates slowly overhead, its concentric rings alive with moving lights, hovering vehicles, and shifting platforms. Soft fog rolls between buildings, diffused white light pulses gently, and distant structures glow faintly. Ultra-detailed realistic CGI, epic scale, cinematic camera movement, symmetrical framing, atmospheric depth, and an overwhelming sense of futuristic grandeur.',
            'Watermark Remover': 'Remove the watermark from the image',
            'Image Editor': 'Edit the image: Place the girl sitting cross-legged on top of the large emerald-green serum jar lid, positioning her in a calm, serene pose wearing light neutral clothing. Surround her with dozens of vibrant yellow lemons floating mid-air in dynamic suspension, some sliced to reveal bright translucent pulp. Float the entire serum jar above soft layered clouds against a clear gradient blue sky. Keep the jar\'s glossy glass surface with golden particles suspended inside catching crisp sunlight. Maintain a cinematic wide-angle perspective with ultra-realistic textures, premium high-fashion product aesthetic and dreamlike editorial visual energy.',
